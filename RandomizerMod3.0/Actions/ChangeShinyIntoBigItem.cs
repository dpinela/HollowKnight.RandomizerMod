...
namespace RandomizerMod.Actions
{
    ...
    public class ChangeShinyIntoBigItem : RandomizerAction
    {
        ...
        public override void Process(string scene, Object changeObj)
        {
            ...
            giveTrinket.AddAction(new RandomizerExecuteLambda(() => GiveItemWrapper(RandomizerLib.GiveAction.Additive, _item, _location)));
            ...
            bigGetFlash.AddAction(new RandomizerExecuteLambda(() => GiveItemWrapper(_action, _item, _location)));
